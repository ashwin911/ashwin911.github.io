...
$(document).ready(function(){$('#triggerGDPR').click(function(){$('#overlayGDPR').fadeIn(300);});$('#closeGDPR').click(function(){$('#overlayGDPR').fadeOut(300);});});})(jQuery);function navToggleClick(){var element=document.getElementById("navnav");if(element.classList.contains('nav-bg'))
